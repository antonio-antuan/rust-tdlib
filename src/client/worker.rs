    ...
    T: TdLibClient + Send + Sync + Clone + 'static,
{
    ...
    pub fn with_auth_state_handler(mut self, auth_state_handler: Arc<DynAuthStateHandler>) -> Self {
    ...
    T: TdLibClient + Send + Sync + Clone + 'static,
{
    ...
    pub fn set_auth_state_handler(&mut self, new_auth_state_handler: Arc<DynAuthStateHandler>) {
        self.auth_state_handler = new_auth_state_handler;
    }

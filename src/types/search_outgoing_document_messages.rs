...
#[doc(hidden)]
pub struct SearchOutgoingDocumentMessagesBuilder {
    inner: SearchOutgoingDocumentMessages,
}

#[deprecated]
pub type RTDSearchOutgoingDocumentMessagesBuilder = SearchOutgoingDocumentMessagesBuilder;

impl SearchOutgoingDocumentMessagesBuilder {
...
impl AsRef<SearchOutgoingDocumentMessages> for SearchOutgoingDocumentMessagesBuilder {
    fn as_ref(&self) -> &SearchOutgoingDocumentMessages {
        &self.inner
    }
}

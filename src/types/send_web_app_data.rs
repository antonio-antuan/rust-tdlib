...
#[doc(hidden)]
pub struct SendWebAppDataBuilder {
    inner: SendWebAppData,
}

#[deprecated]
pub type RTDSendWebAppDataBuilder = SendWebAppDataBuilder;

impl SendWebAppDataBuilder {
...
impl AsRef<SendWebAppData> for SendWebAppDataBuilder {
    fn as_ref(&self) -> &SendWebAppData {
        &self.inner
    }
}

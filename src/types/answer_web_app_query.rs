...
#[doc(hidden)]
pub struct RTDAnswerWebAppQueryBuilder {
    inner: AnswerWebAppQuery,
}

impl RTDAnswerWebAppQueryBuilder {
...
impl AsRef<AnswerWebAppQuery> for RTDAnswerWebAppQueryBuilder {
    fn as_ref(&self) -> &AnswerWebAppQuery {
        &self.inner
    }
}

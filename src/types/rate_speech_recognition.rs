...
#[doc(hidden)]
pub struct RateSpeechRecognitionBuilder {
    inner: RateSpeechRecognition,
}

#[deprecated]
pub type RTDRateSpeechRecognitionBuilder = RateSpeechRecognitionBuilder;

impl RateSpeechRecognitionBuilder {
...
impl AsRef<RateSpeechRecognition> for RateSpeechRecognitionBuilder {
    fn as_ref(&self) -> &RateSpeechRecognition {
        &self.inner
    }
}

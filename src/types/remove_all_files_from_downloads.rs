...
#[doc(hidden)]
pub struct RemoveAllFilesFromDownloadsBuilder {
    inner: RemoveAllFilesFromDownloads,
}

#[deprecated]
pub type RTDRemoveAllFilesFromDownloadsBuilder = RemoveAllFilesFromDownloadsBuilder;

impl RemoveAllFilesFromDownloadsBuilder {
...
impl AsRef<RemoveAllFilesFromDownloads> for RemoveAllFilesFromDownloadsBuilder {
    fn as_ref(&self) -> &RemoveAllFilesFromDownloads {
        &self.inner
    }
}

...
#[doc(hidden)]
pub struct RTDToggleSupergroupJoinByRequestBuilder {
    inner: ToggleSupergroupJoinByRequest,
}

impl RTDToggleSupergroupJoinByRequestBuilder {
...
impl AsRef<ToggleSupergroupJoinByRequest> for RTDToggleSupergroupJoinByRequestBuilder {
    fn as_ref(&self) -> &ToggleSupergroupJoinByRequest {
        &self.inner
    }
}

...
impl GetLanguagePackString {
    ...
    pub fn builder() -> GetLanguagePackStringBuilder {
        ...
        GetLanguagePackStringBuilder { inner }
    }
...
#[deprecated]
pub type RTDGetLanguagePackStringBuilder = GetLanguagePackStringBuilder;
...
impl AsRef<GetLanguagePackString> for GetLanguagePackStringBuilder {
    fn as_ref(&self) -> &GetLanguagePackString {
        &self.inner
    }
}

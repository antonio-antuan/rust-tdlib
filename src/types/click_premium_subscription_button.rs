...
impl ClickPremiumSubscriptionButton {
    ...
    pub fn builder() -> RTDClickPremiumSubscriptionButtonBuilder {
        let mut inner = ClickPremiumSubscriptionButton::default();
        inner.extra = Some(Uuid::new_v4().to_string());

        inner.td_type = "clickPremiumSubscriptionButton".to_string();

        RTDClickPremiumSubscriptionButtonBuilder { inner }
    }
}

#[doc(hidden)]
pub struct RTDClickPremiumSubscriptionButtonBuilder {
    inner: ClickPremiumSubscriptionButton,
}

impl RTDClickPremiumSubscriptionButtonBuilder {
...
impl AsRef<ClickPremiumSubscriptionButton> for RTDClickPremiumSubscriptionButtonBuilder {
    fn as_ref(&self) -> &ClickPremiumSubscriptionButton {
        &self.inner
    }
}

...
#[doc(hidden)]
pub struct RTDSearchFileDownloadsBuilder {
    inner: SearchFileDownloads,
}

impl RTDSearchFileDownloadsBuilder {
...
impl AsRef<SearchFileDownloads> for RTDSearchFileDownloadsBuilder {
    fn as_ref(&self) -> &SearchFileDownloads {
        &self.inner
    }
}

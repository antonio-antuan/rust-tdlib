...
#[doc(hidden)]
pub struct GetMessageAddedReactionsBuilder {
    inner: GetMessageAddedReactions,
}

#[deprecated]
pub type RTDGetMessageAddedReactionsBuilder = GetMessageAddedReactionsBuilder;

impl GetMessageAddedReactionsBuilder {
...
impl AsRef<GetMessageAddedReactions> for GetMessageAddedReactionsBuilder {
    fn as_ref(&self) -> &GetMessageAddedReactions {
        &self.inner
    }
}

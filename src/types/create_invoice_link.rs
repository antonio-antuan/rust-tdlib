...
#[doc(hidden)]
pub struct CreateInvoiceLinkBuilder {
    inner: CreateInvoiceLink,
}

#[deprecated]
pub type RTDCreateInvoiceLinkBuilder = CreateInvoiceLinkBuilder;
...
impl AsRef<CreateInvoiceLink> for CreateInvoiceLinkBuilder {
    fn as_ref(&self) -> &CreateInvoiceLink {
        &self.inner
    }
}

...
#[doc(hidden)]
pub struct RTDAddSavedNotificationSoundBuilder {
    inner: AddSavedNotificationSound,
}

impl RTDAddSavedNotificationSoundBuilder {
...
impl AsRef<AddSavedNotificationSound> for RTDAddSavedNotificationSoundBuilder {
    fn as_ref(&self) -> &AddSavedNotificationSound {
        &self.inner
    }
}

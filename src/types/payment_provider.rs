...
pub enum PaymentProvider {
    ...
    #[serde(rename = "paymentProviderOther")]
    Other(PaymentProviderOther),
    /// Smart Glocal payment provider
    #[serde(rename = "paymentProviderSmartGlocal")]
    SmartGlocal(PaymentProviderSmartGlocal),
    /// Stripe payment provider
    #[serde(rename = "paymentProviderStripe")]
...
impl PaymentProviderOther {
    ...
    pub fn builder() -> PaymentProviderOtherBuilder {
        let mut inner = PaymentProviderOther::default();
        inner.extra = Some(Uuid::new_v4().to_string());

        PaymentProviderOtherBuilder { inner }
    }
...
#[doc(hidden)]
pub struct PaymentProviderOtherBuilder {
    inner: PaymentProviderOther,
}

#[deprecated]
pub type RTDPaymentProviderOtherBuilder = PaymentProviderOtherBuilder;

impl PaymentProviderOtherBuilder {
...
impl AsRef<PaymentProviderOther> for PaymentProviderOtherBuilder {
    fn as_ref(&self) -> &PaymentProviderOther {
        &self.inner
    }
}
...
impl PaymentProviderSmartGlocal {
    ...
    pub fn builder() -> PaymentProviderSmartGlocalBuilder {
        let mut inner = PaymentProviderSmartGlocal::default();
        inner.extra = Some(Uuid::new_v4().to_string());

        PaymentProviderSmartGlocalBuilder { inner }
    }
...
#[doc(hidden)]
pub struct PaymentProviderSmartGlocalBuilder {
    inner: PaymentProviderSmartGlocal,
}

#[deprecated]
pub type RTDPaymentProviderSmartGlocalBuilder = PaymentProviderSmartGlocalBuilder;

impl PaymentProviderSmartGlocalBuilder {
...
impl AsRef<PaymentProviderSmartGlocal> for PaymentProviderSmartGlocalBuilder {
    fn as_ref(&self) -> &PaymentProviderSmartGlocal {
        &self.inner
    }
}
...
impl PaymentProviderStripe {
    ...
    pub fn builder() -> PaymentProviderStripeBuilder {
        let mut inner = PaymentProviderStripe::default();
        inner.extra = Some(Uuid::new_v4().to_string());

        PaymentProviderStripeBuilder { inner }
    }
...
#[doc(hidden)]
pub struct PaymentProviderStripeBuilder {
    inner: PaymentProviderStripe,
}

#[deprecated]
pub type RTDPaymentProviderStripeBuilder = PaymentProviderStripeBuilder;

impl PaymentProviderStripeBuilder {
...
impl AsRef<PaymentProviderStripe> for PaymentProviderStripeBuilder {
    fn as_ref(&self) -> &PaymentProviderStripe {
        &self.inner
    }
}

...
#[doc(hidden)]
pub struct RemoveFileFromDownloadsBuilder {
    inner: RemoveFileFromDownloads,
}

#[deprecated]
pub type RTDRemoveFileFromDownloadsBuilder = RemoveFileFromDownloadsBuilder;

impl RemoveFileFromDownloadsBuilder {
...
impl AsRef<RemoveFileFromDownloads> for RemoveFileFromDownloadsBuilder {
    fn as_ref(&self) -> &RemoveFileFromDownloads {
        &self.inner
    }
}

...
#[doc(hidden)]
pub struct GetAttachmentMenuBotBuilder {
    inner: GetAttachmentMenuBot,
}

#[deprecated]
pub type RTDGetAttachmentMenuBotBuilder = GetAttachmentMenuBotBuilder;

impl GetAttachmentMenuBotBuilder {
...
impl AsRef<GetAttachmentMenuBot> for GetAttachmentMenuBotBuilder {
    fn as_ref(&self) -> &GetAttachmentMenuBot {
        &self.inner
    }
}

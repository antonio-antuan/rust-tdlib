...
impl WriteGeneratedFilePart {
    ...
    pub fn builder() -> WriteGeneratedFilePartBuilder {
        ...
        WriteGeneratedFilePartBuilder { inner }
    }
...
#[deprecated]
pub type RTDWriteGeneratedFilePartBuilder = WriteGeneratedFilePartBuilder;
...
impl AsRef<WriteGeneratedFilePart> for WriteGeneratedFilePartBuilder {
    fn as_ref(&self) -> &WriteGeneratedFilePart {
        &self.inner
    }
}

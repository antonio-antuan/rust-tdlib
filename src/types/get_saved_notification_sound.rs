...
#[doc(hidden)]
pub struct RTDGetSavedNotificationSoundBuilder {
    inner: GetSavedNotificationSound,
}

impl RTDGetSavedNotificationSoundBuilder {
...
impl AsRef<GetSavedNotificationSound> for RTDGetSavedNotificationSoundBuilder {
    fn as_ref(&self) -> &GetSavedNotificationSound {
        &self.inner
    }
}

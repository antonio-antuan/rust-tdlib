...
#[doc(hidden)]
pub struct RTDGetPremiumLimitBuilder {
    inner: GetPremiumLimit,
}

impl RTDGetPremiumLimitBuilder {
...
impl AsRef<GetPremiumLimit> for RTDGetPremiumLimitBuilder {
    fn as_ref(&self) -> &GetPremiumLimit {
        &self.inner
    }
}

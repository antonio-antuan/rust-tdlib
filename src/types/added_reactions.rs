...
impl AddedReactions {
    ...
    pub fn builder() -> AddedReactionsBuilder {
        let mut inner = AddedReactions::default();
        inner.extra = Some(Uuid::new_v4().to_string());

        AddedReactionsBuilder { inner }
    }
...
#[doc(hidden)]
pub struct AddedReactionsBuilder {
    inner: AddedReactions,
}

#[deprecated]
pub type RTDAddedReactionsBuilder = AddedReactionsBuilder;

impl AddedReactionsBuilder {
...
impl AsRef<AddedReactions> for AddedReactionsBuilder {
    fn as_ref(&self) -> &AddedReactions {
        &self.inner
    }
}

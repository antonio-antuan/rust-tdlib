...
#[doc(hidden)]
pub struct ReplacePrimaryChatInviteLinkBuilder {
    inner: ReplacePrimaryChatInviteLink,
}

#[deprecated]
pub type RTDReplacePrimaryChatInviteLinkBuilder = ReplacePrimaryChatInviteLinkBuilder;

impl ReplacePrimaryChatInviteLinkBuilder {
...
impl AsRef<ReplacePrimaryChatInviteLink> for ReplacePrimaryChatInviteLinkBuilder {
    fn as_ref(&self) -> &ReplacePrimaryChatInviteLink {
        &self.inner
    }
}

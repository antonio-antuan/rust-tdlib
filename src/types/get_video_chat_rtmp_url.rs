...
#[doc(hidden)]
pub struct GetVideoChatRtmpUrlBuilder {
    inner: GetVideoChatRtmpUrl,
}

#[deprecated]
pub type RTDGetVideoChatRtmpUrlBuilder = GetVideoChatRtmpUrlBuilder;

impl GetVideoChatRtmpUrlBuilder {
...
impl AsRef<GetVideoChatRtmpUrl> for GetVideoChatRtmpUrlBuilder {
    fn as_ref(&self) -> &GetVideoChatRtmpUrl {
        &self.inner
    }
}

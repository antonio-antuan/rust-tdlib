...
impl JsonObjectMember {
    ...
    pub fn builder() -> JsonObjectMemberBuilder {
        let mut inner = JsonObjectMember::default();
        inner.extra = Some(Uuid::new_v4().to_string());

        JsonObjectMemberBuilder { inner }
    }
...
#[doc(hidden)]
pub struct JsonObjectMemberBuilder {
    inner: JsonObjectMember,
}

#[deprecated]
pub type RTDJsonObjectMemberBuilder = JsonObjectMemberBuilder;

impl JsonObjectMemberBuilder {
...
impl AsRef<JsonObjectMember> for JsonObjectMemberBuilder {
    fn as_ref(&self) -> &JsonObjectMember {
        &self.inner
    }
}

...
#[doc(hidden)]
pub struct RemoveSavedNotificationSoundBuilder {
    inner: RemoveSavedNotificationSound,
}

#[deprecated]
pub type RTDRemoveSavedNotificationSoundBuilder = RemoveSavedNotificationSoundBuilder;

impl RemoveSavedNotificationSoundBuilder {
...
impl AsRef<RemoveSavedNotificationSound> for RemoveSavedNotificationSoundBuilder {
    fn as_ref(&self) -> &RemoveSavedNotificationSound {
        &self.inner
    }
}

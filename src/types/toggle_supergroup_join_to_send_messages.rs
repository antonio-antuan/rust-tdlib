...
impl ToggleSupergroupJoinToSendMessages {
    ...
    pub fn builder() -> ToggleSupergroupJoinToSendMessagesBuilder {
        ...
        ToggleSupergroupJoinToSendMessagesBuilder { inner }
    }
...
#[doc(hidden)]
pub struct ToggleSupergroupJoinToSendMessagesBuilder {
    inner: ToggleSupergroupJoinToSendMessages,
}

#[deprecated]
pub type RTDToggleSupergroupJoinToSendMessagesBuilder = ToggleSupergroupJoinToSendMessagesBuilder;

impl ToggleSupergroupJoinToSendMessagesBuilder {
...
impl AsRef<ToggleSupergroupJoinToSendMessages> for ToggleSupergroupJoinToSendMessagesBuilder {
    fn as_ref(&self) -> &ToggleSupergroupJoinToSendMessages {
        &self.inner
    }
}

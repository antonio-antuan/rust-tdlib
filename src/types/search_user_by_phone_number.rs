...
#[doc(hidden)]
pub struct SearchUserByPhoneNumberBuilder {
    inner: SearchUserByPhoneNumber,
}

#[deprecated]
pub type RTDSearchUserByPhoneNumberBuilder = SearchUserByPhoneNumberBuilder;

impl SearchUserByPhoneNumberBuilder {
...
impl AsRef<SearchUserByPhoneNumber> for SearchUserByPhoneNumberBuilder {
    fn as_ref(&self) -> &SearchUserByPhoneNumber {
        &self.inner
    }
}

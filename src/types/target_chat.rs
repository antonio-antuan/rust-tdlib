...
pub enum TargetChat {
    ...
    #[serde(rename = "targetChatChosen")]
    Chosen(TargetChatChosen),
    /// The currently opened chat needs to be kept
    #[serde(rename = "targetChatCurrent")]
    Current(TargetChatCurrent),
    /// The chat needs to be open with the provided internal link
    #[serde(rename = "targetChatInternalLink")]
...
impl TargetChatChosen {
    ...
    pub fn builder() -> TargetChatChosenBuilder {
        let mut inner = TargetChatChosen::default();
        inner.extra = Some(Uuid::new_v4().to_string());

        TargetChatChosenBuilder { inner }
    }
...
#[doc(hidden)]
pub struct TargetChatChosenBuilder {
    inner: TargetChatChosen,
}

#[deprecated]
pub type RTDTargetChatChosenBuilder = TargetChatChosenBuilder;

impl TargetChatChosenBuilder {
...
impl AsRef<TargetChatChosen> for TargetChatChosenBuilder {
    fn as_ref(&self) -> &TargetChatChosen {
        &self.inner
    }
}
...
impl TargetChatCurrent {
    ...
    pub fn builder() -> TargetChatCurrentBuilder {
        let mut inner = TargetChatCurrent::default();
        inner.extra = Some(Uuid::new_v4().to_string());

        TargetChatCurrentBuilder { inner }
    }
}

#[doc(hidden)]
pub struct TargetChatCurrentBuilder {
    inner: TargetChatCurrent,
}

#[deprecated]
pub type RTDTargetChatCurrentBuilder = TargetChatCurrentBuilder;

impl TargetChatCurrentBuilder {
...
impl AsRef<TargetChatCurrent> for TargetChatCurrentBuilder {
    fn as_ref(&self) -> &TargetChatCurrent {
        &self.inner
    }
}
...
impl TargetChatInternalLink {
    ...
    pub fn builder() -> TargetChatInternalLinkBuilder {
        let mut inner = TargetChatInternalLink::default();
        inner.extra = Some(Uuid::new_v4().to_string());

        TargetChatInternalLinkBuilder { inner }
    }
...
#[doc(hidden)]
pub struct TargetChatInternalLinkBuilder {
    inner: TargetChatInternalLink,
}

#[deprecated]
pub type RTDTargetChatInternalLinkBuilder = TargetChatInternalLinkBuilder;

impl TargetChatInternalLinkBuilder {
...
impl AsRef<TargetChatInternalLink> for TargetChatInternalLinkBuilder {
    fn as_ref(&self) -> &TargetChatInternalLink {
        &self.inner
    }
}

...
#[doc(hidden)]
pub struct GetMenuButtonBuilder {
    inner: GetMenuButton,
}

#[deprecated]
pub type RTDGetMenuButtonBuilder = GetMenuButtonBuilder;

impl GetMenuButtonBuilder {
...
impl AsRef<GetMenuButton> for GetMenuButtonBuilder {
    fn as_ref(&self) -> &GetMenuButton {
        &self.inner
    }
}

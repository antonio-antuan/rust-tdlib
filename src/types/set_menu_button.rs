...
#[doc(hidden)]
pub struct SetMenuButtonBuilder {
    inner: SetMenuButton,
}

#[deprecated]
pub type RTDSetMenuButtonBuilder = SetMenuButtonBuilder;

impl SetMenuButtonBuilder {
...
impl AsRef<SetMenuButton> for SetMenuButtonBuilder {
    fn as_ref(&self) -> &SetMenuButton {
        &self.inner
    }
}

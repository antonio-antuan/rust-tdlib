...
impl TestCallVectorStringObject {
    ...
    pub fn builder() -> TestCallVectorStringObjectBuilder {
        ...
        TestCallVectorStringObjectBuilder { inner }
    }
...
#[deprecated]
pub type RTDTestCallVectorStringObjectBuilder = TestCallVectorStringObjectBuilder;
...
impl AsRef<TestCallVectorStringObject> for TestCallVectorStringObjectBuilder {
    fn as_ref(&self) -> &TestCallVectorStringObject {
        &self.inner
    }
}

...
#[doc(hidden)]
pub struct RTDSendCallLogBuilder {
    inner: SendCallLog,
}

impl RTDSendCallLogBuilder {
...
impl AsRef<SendCallLog> for RTDSendCallLogBuilder {
    fn as_ref(&self) -> &SendCallLog {
        &self.inner
    }
}
